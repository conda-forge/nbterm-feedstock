...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nbterm-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12439&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nbterm-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nbterm` can be installed with:

```
conda install nbterm
```

It is possible to list all of the versions of `nbterm` available on your platform with:
